...
export const metadata: Metadata = {
  ...
  description: "Welcome to A.H.Jovin's portifolio",
  keywords: "Abayo Hirwa Jovin, Hirwa, Jovin, web developer, portfolio",
  authors: "Abayo Hirwa Jovin",
  openGraph: {
    title: "Abayo Hirwa Jovin - Web Developer",
    description:
      "Explore the portfolio of Abayo Hirwa Jovin, featuring projects in Next.js, React, and more.",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="keywords"
          content="Abayo Hirwa Jovin, Hirwa, Jovin, web developer, portfolio"
        />
        <meta name="author" content="Abayo Hirwa Jovin" />
        <meta property="og:title" content="Abayo Hirwa Jovin - Web Developer" />
        <meta
          property="og:description"
          content="Explore the portfolio of Abayo Hirwa Jovin and more."
        />
