...
//   return (
//     <div
//       className="space-y-5 px-4 md:px-10 mx-0 bg-red-500 md:mx-10 py-5"
//       id="projects"
//     >
...
//             height={375}
//           />
//           <div className="absolute inset-0 bg-black text-white rounded-lg flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
...
const Projects = () => {
  ...
  return (
    <div className="space-y-5 px-4 md:px-10 mx-0 md:mx-10 py-5" id="projects">
      <div className="flex justify-center font-bold text-3xl my-5 text-black dark:text-white">
        <h1>Projects</h1>
      </div>
